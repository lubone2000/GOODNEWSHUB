                                      ...
                                      onError={(e) => {
                                        ...
                                        if (parent) {
                                          ...
                                          icon.innerHTML = `
                                            ...
                                            <p class="text-[8px] mt-2 font-bold uppercase tracking-widest">Preview Unavailable</p>
                                            <a href="${img.url}" target="_blank" rel="noopener noreferrer" class="text-[6px] mt-1 underline hover:opacity-100 pointer-events-auto">View Source</a>
                                          `;
